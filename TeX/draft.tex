...
\KwOut{Finite list of pairs $(n,d)$ such that any isolated point on $X_1(n)$ associated to $E$ maps down under the natural projection map to a point of degree $d$ in this list. \sachi{is this better?} \abbey{Don't we mean ``Finite list of pairs $(n_i,d_i)$ such that any isolated point on $X_1(n)$ associated to $E$ maps down under the natural projection map to a point of degree $d_i$ on $X_1(n_i)$ for some $n_i \mid n$ and $(n_i,d_i)$ in this list. But maybe with better notation.}}
